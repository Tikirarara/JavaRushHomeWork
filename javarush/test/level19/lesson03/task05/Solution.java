...
public class Solution
{
    ...
    public static class DataAdapter implements RowItem
    {
        ...
        {
            String countryCode = "";
            for (Map.Entry<String, String> enty : countries.entrySet())
            {
                if (enty.getValue().equals(customer.getCountryName()))
                {
                    countryCode = enty.getKey();
                }
            }
            return countryCode;
        }
        ...
        {
            String number = contact.getPhoneNumber().replace("(", "")
                    .replace(")", "")
                    .replace("-", "");
